...
function MiniCardComponent2({ className = '', day , title,day1,imageName,profileStatus,percentage,progress1,progress}) {
   ...
   // const percentage = 73
    return (
        ...
        <div className={progress}>
                <ProgressBar className="progressbar" variant="info" now={percentage} style={{ height: "5px", margin:"10px 0px 10px 0px"}}/>
...
export default MiniCardComponent2;
